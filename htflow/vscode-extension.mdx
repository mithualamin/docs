  ...
  <Tab title="Via Extension (Recommended)">
    <Steps>
      ...
      <Step title="Run Build for conversion">
        In the HTFlow panel, click the **"Build"** tab and then click the **"Build"** button.

        This will create a folder in your project root called **htflow-copyable** and organize each HTML file
        as a separate folder containing the copyable HTML, CSS, and JS files. These files can be used to convert
