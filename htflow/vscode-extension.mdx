  ...
  <Tab title="Via Extension (Recommended)">
    ...
    <Card title="3. Initialize Project" icon="folder-plus">
      ...
      **Example AI Prompts for HTFlow Development**
      ...
      ```text
      "Create a modern SaaS landing page using HTFlow-compatible HTML, CSS, and JavaScript.
      ...
      **HTFlow Compliance:**
      - Wrap ALL content in <div class='htflow-wrapper'>
      - Add data-ht-styles to <style> tags
      - Add data-ht-main-script to <script> tags
      - Give every element a descriptive class name
      - Use semantic HTML elements (header, main, section, footer)
      - Include proper alt attributes for images
      - Use inline SVG for icons (no emojis)
      - Follow HTFlow CSS and JavaScript guidelines
